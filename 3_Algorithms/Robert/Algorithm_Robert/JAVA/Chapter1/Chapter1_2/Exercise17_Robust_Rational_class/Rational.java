...
package Chapter1.Chapter1_2.Exercise17_Robust_Rational_class;
...
public class Rational {
    ...
    Rational(long n, long d) {
        assert d != 0 : "Invalid denominator for it cannot be zero";
        numerator = n;
        denominator = d;
    }
    ...
    public Rational divides(Rational b) {
        assert b.numerator != 0 : "Overflow for that numerator of second operand is zero";
